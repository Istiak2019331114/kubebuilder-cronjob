...
var _ = Describe("CronJob controller", func() {
	...
	Context("When updating CronJob Status", func() {
		BeforeEach(func() {
			...
			_ = k8sClient.DeleteAllOf(ctx, &batchv1.Job{}, client.InNamespace("default"))
			// Optionally: delete the test CronJob too
			_ = k8sClient.DeleteAllOf(ctx, &cronjobv1.CronJob{}, client.InNamespace("default"))
		})
